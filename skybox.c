...
/*   Updated: 2020/01/21 02:53:56 by youkhart         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			get_sky_color(int x, int y)
{
	...
	ry = -fmod(((t_cam *)((t_obj *)g_rt.curr_cam->content)->details)->rot.y, 2 * M_PI) * 0.4;
	...
	return (mult_colors(g_rt.skybox.img_data[index], 0.5));
}
